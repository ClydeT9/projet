class SoftwaresController < ApplicationController
  ...
  def show
    ...
    @related_softwares = Software.joins(:categories).where('softwares.id != ?', @software.id).where(software_categories: {category_id: @software.category_ids}).limit(3).distinct
